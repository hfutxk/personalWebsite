...
function loadSimpleBlog(blogData){
	$('#latestBlog').append('<div class="col-md-3 col-sm-6 col-padding article-box-div" >'
		...
		+ '<div class="desc">'
		+ '<h3 class="article-title"><a href="/queryBlog?blogId=' + blogData.blogId +'">' + blogData.blogTitle + '</a></h3>'
		...
		+ '<a href="/queryBlog?blogId='+ blogData.blogId +'" class="lead read-more">阅读更多 <i class="glyphicon glyphicon-arrow-right"></i></a>'
		+ '</div>'
		+ '</div>');
}